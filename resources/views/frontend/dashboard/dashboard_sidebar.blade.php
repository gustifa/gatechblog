<div class="widget-content">
                                <ul class="category-list ">
                                    ...
                                    <li><a href="{{route('user.profile.view')}}"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a></li>
                                    ...
                                    <li><a href="{{route('user.wishlist.details')}}"><i class="fa fa-indent" aria-hidden="true"></i> Wishlist  </a></li>
                                    <li><a href="{{route('user.compare.details')}}"><i class="fa fa-indent" aria-hidden="true"></i> Comparelist  </a></li>
