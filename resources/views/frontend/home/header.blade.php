...
<header class="main-header">
                ...
                <div class="top-inner clearfix">
                    <div class="left-column pull-left">
                        <ul class="info clearfix">
                            ...
                            <li><i class="far fa-phone"></i><a href="tel:{{$siteSetting->support_phone}}">{{$siteSetting->support_phone}}</a></li>
                        </ul>
                    </div>
                    <div class="right-column pull-right">
                        <ul class="social-links clearfix">
                            <li><a href="{{$siteSetting->facebook}}"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="{{$siteSetting->twiter}}"><i class="fab fa-twitter"></i></a></li>
                    ...
                    @auth
                        ...
                        <div class="sign-box">
                            ...
                            @elseif($profileData->role === 'admin')
                                <a href="{{route('admin.dashboard')}}"><i class="fas fa-home"></i>Dashboard</a>
                                <a href="{{route('admin.logout')}}"><i class="fas fa-user"></i>Logout</a>

                            @elseif($profileData->role === 'agent')
                                <a href="{{route('agent.dashboard')}}"><i class="fas fa-home"></i>Dashboard</a>
            ...
            <div class="main-box">
            <div class="logo-box">
                <figure class="logo"><a href="{{route('frontend.index')}}"><img src="{{asset('frontend/assets/images/logo.png')}} " alt=""></a></figure>
            </div>
                ...
                <nav class="main-menu navbar-expand-md navbar-light">
                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                        <ul class="navigation clearfix">
                            <li class="current dropdown"><a href="{{route('frontend.index')}}"><span>Home</span></a>
                                <ul>
                                    <li><a href="{{route('frontend.index')}}">Main Home</a></li>
