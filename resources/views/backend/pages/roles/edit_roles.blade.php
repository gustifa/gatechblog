								...
								<h6 class="card-title">Edit Roles</h6>
									<form id="myForm" method="post" action="{{route('update.roles')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select name="name" id="group_name" class="form-control">
                                                            <option selected="" disabled="">Select Group</option>
                                                            <option value="SuperAdmin" {{$roles->name == 'SuperAdmin' ? 'selected' : ''}}>SuperAdmin</option>
                                                            <option value="Admin" {{$roles->name == 'Admin' ? 'selected' : ''}}>Admin</option>
                                                            <option value="Agent" {{$roles->name == 'Agent' ? 'selected' : ''}}>Agent</option>
                                                            <option value="User" {{$roles->name == 'User' ? 'selected' : ''}}>User</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="mb-3">
										<button type="submit" class="btn btn-primary submit">Update Permission</button>
