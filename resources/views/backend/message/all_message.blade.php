                      ...
                      <ul class="nav flex-column">
                        <li class="nav-item active">
                          <a class="nav-link d-flex align-items-center" href="{{route('admin.property.message')}}">
                            ...
                            <span class="badge bg-danger fw-bolder ms-auto">{{count($message)}}
                            @else
                  ...
                  <div class="col-lg-9">
                      ...
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                          <div class="d-flex align-items-end mb-2 mb-md-0">
                            ...
                            @if(count($message) == !NULL)
                              <span class="text-muted">({{count($message)}} new messages)</span>
                            @else
                            <span class="text-muted">(0 new messages)</span>
                            @endif
                          </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="email-list">
                      ...
                      <div class="email-list-item email-list-item--unread">
                        ...
                        <a href="{{route('admin.message.details', $item->id)}}" class="email-list-detail">
                          <div class="content">
