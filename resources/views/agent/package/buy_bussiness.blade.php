...
<div class="main-wrapper">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
            <div class="card">
                <form action="{{route('store.bussiness.plan')}}" method="POST">
                    @csrf
              <div class="card-body">
                ...
                <div class="container-fluid w-100">
                    <button type="submit" class="btn btn-primary float-end mt-4 ms-2">Buy</button>
